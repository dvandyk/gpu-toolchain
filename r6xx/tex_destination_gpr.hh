...
#ifndef GPU_GUARD_R6XX_TEX_DESTINATION_GPR_HH
#define GPU_GUARD_R6XX_TEX_DESTINATION_GPR_HH 1
...
namespace gpu
{
    namespace r6xx
    {
        namespace tex
        {
            ...
            {
                typedef Tuple<Enumeration<3>, Enumeration<3>, Enumeration<3>, Enumeration<3> > Selector;
